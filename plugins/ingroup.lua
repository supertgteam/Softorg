...
local function show_group_settingsmod(msg, data, target)
  ...
  local text = "⚙تنظیمات گروه\n› ℹقفل اسم گروه : "..settings.lock_name.."\n› ℹقفل عکس گروه : "..settings.lock_photo.."\n› ℹقفل ارسال تگ : "..settings.lock_tag.."\n› ℹ قفل اددکردن ممبر : "..settings.lock_member.."\n› ℹقفل انگلیسی حرف زدن : "..settings.lock_eng.."\n› ℹخروج از گروه=بن : "..settings.leave_ban.."\n› ℹقفل عربی حرف زدن : "..settings.lock_arabic.."\n› ℹقفل فحش دادن :
: "..settings.lock_fosh.."\n› ℹقفل فروراد  : "..settings.lock_share.."\n› ℹقفل چت کردن : "..settings.lock_chat.."\n› ℹقفل ارسال گیف : "..settings.lock_gif.."\n› ℹقفل ارسال اموجی : "..settings.lock_emogi.."\n› ℹقفل فرستادن فیلم،عکس،ویدئو : "..settings.lock_media.."\n› ℹقفل حرف های نامناسب : "..settings.lock_badw.."\n› ℹقفل تبلیغات و لینک : "..settings.lock_link.."\n› ℹقفل فارسی حرف زدن : "..settings.lock_fa.."\n› ℹ قفل ورود اعضای جدید : "..settings.lock_join.."\n› ℹقفل فرستادن استیکر : "..settings.sticker.."\n› 🔧حساسیت به اسپم : "..NUM_MSG_MAX.."\n› 🔧وضعیت بوت : "..bots_protection--"\nPublic: "..public
  return text
end
